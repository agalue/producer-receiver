...
type TroubleTicketState int32

const (
	TroubleTicketState_OPEN            TroubleTicketState = 0
	TroubleTicketState_CREATE_PENDING  TroubleTicketState = 1
	TroubleTicketState_CREATE_FAILED   TroubleTicketState = 2
	TroubleTicketState_UPDATE_PENDING  TroubleTicketState = 3
	TroubleTicketState_UPDATE_FAILED   TroubleTicketState = 4
	TroubleTicketState_CLOSED          TroubleTicketState = 5
	TroubleTicketState_CLOSE_PENDING   TroubleTicketState = 6
	TroubleTicketState_CLOSE_FAILED    TroubleTicketState = 7
	TroubleTicketState_RESOLVED        TroubleTicketState = 8
	TroubleTicketState_RESOLVE_PENDING TroubleTicketState = 9
	TroubleTicketState_RESOLVE_FAILED  TroubleTicketState = 10
	TroubleTicketState_CANCELLED       TroubleTicketState = 11
	TroubleTicketState_CANCEL_PENDING  TroubleTicketState = 12
	TroubleTicketState_CANCEL_FAILED   TroubleTicketState = 13
)

// Enum value maps for TroubleTicketState.
var (
	TroubleTicketState_name = map[int32]string{
		0:  "OPEN",
		1:  "CREATE_PENDING",
		2:  "CREATE_FAILED",
		3:  "UPDATE_PENDING",
	...
	TroubleTicketState_value = map[string]int32{
		"OPEN":            0,
		"CREATE_PENDING":  1,
		"CREATE_FAILED":   2,
		"UPDATE_PENDING":  3,
...
func (x TroubleTicketState) Enum() *TroubleTicketState {
	p := new(TroubleTicketState)
	*p = x
	return p
}

func (x TroubleTicketState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TroubleTicketState) Descriptor() protoreflect.EnumDescriptor {
	return file_opennms_kafka_producer_proto_enumTypes[1].Descriptor()
}

func (TroubleTicketState) Type() protoreflect.EnumType {
	return &file_opennms_kafka_producer_proto_enumTypes[1]
}

func (x TroubleTicketState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TroubleTicketState.Descriptor instead.
func (TroubleTicketState) EnumDescriptor() ([]byte, []int) {
...
func (IpInterface_PrimaryType) EnumDescriptor() ([]byte, []int) {
	return file_opennms_kafka_producer_proto_rawDescGZIP(), []int{6, 0}
}
...
func (TopologyRef_Protocol) Descriptor() protoreflect.EnumDescriptor {
	return file_opennms_kafka_producer_proto_enumTypes[5].Descriptor()
}

func (TopologyRef_Protocol) Type() protoreflect.EnumType {
	return &file_opennms_kafka_producer_proto_enumTypes[5]
}
...
func (TopologyRef_Protocol) EnumDescriptor() ([]byte, []int) {
	return file_opennms_kafka_producer_proto_rawDescGZIP(), []int{11, 0}
}
...
type Event struct {
	...
	DistPoller   string            `protobuf:"bytes,15,opt,name=dist_poller,json=distPoller,proto3" json:"dist_poller,omitempty"`
	SnmpInfo     *SnmpInfo         `protobuf:"bytes,16,opt,name=snmpInfo,proto3" json:"snmpInfo,omitempty"`
}
...
type Alarm struct {
	...
	TroubleTicketId       string             `protobuf:"bytes,23,opt,name=trouble_ticket_id,json=troubleTicketId,proto3" json:"trouble_ticket_id,omitempty"`
	TroubleTicketState    TroubleTicketState `protobuf:"varint,24,opt,name=trouble_ticket_state,json=troubleTicketState,proto3,enum=TroubleTicketState" json:"trouble_ticket_state,omitempty"`
...
func (x *Alarm) GetTroubleTicketId() string {
	if x != nil {
		return x.TroubleTicketId
	}
	return ""
}

func (x *Alarm) GetTroubleTicketState() TroubleTicketState {
	if x != nil {
		return x.TroubleTicketState
	}
	return TroubleTicketState_OPEN
}
...
func (x *TopologyEdge) Reset() {
	*x = TopologyEdge{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opennms_kafka_producer_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TopologyEdge) Descriptor() ([]byte, []int) {
	return file_opennms_kafka_producer_proto_rawDescGZIP(), []int{14}
}
...
var file_opennms_kafka_producer_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0x4e, 0x0a, 0x0e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	...
	,
	...
	0x28, 0x09, 0x52, 0x03, 0x75, 0x65, 0x69, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	...
	0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x2d, 0x0a, 0x09, 0x70, 0x61, 0x72,
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x52, 0x09, 0x70,
	0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x61,
	...
	,
	...
	,
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x50, 0x0a, 0x0c, 0x46, 0x65,
	0x65, 0x64, 0x62, 0x61, 0x63, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a, 0x0e, 0x46, 0x41,
	0x4c, 0x53, 0x45, 0x5f, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x49, 0x56, 0x45, 0x10, 0x00, 0x12, 0x12,
	0x0a, 0x0e, 0x46, 0x41, 0x4c, 0x53, 0x45, 0x5f, 0x4e, 0x45, 0x47, 0x41, 0x54, 0x49, 0x56, 0x45,
	0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x43, 0x4f, 0x52, 0x52, 0x45, 0x43, 0x54, 0x10, 0x02, 0x12,
	0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x03, 0x22, 0xeb, 0x01, 0x0a,
	0x0b, 0x49, 0x70, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02,
	...
	,
	...
	,
...
var file_opennms_kafka_producer_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_opennms_kafka_producer_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_opennms_kafka_producer_proto_goTypes = []interface{}{
	(Severity)(0),                   // 0: Severity
	(TroubleTicketState)(0),         // 1: TroubleTicketState
	(Alarm_Type)(0),                 // 2: Alarm.Type
	(AlarmFeedback_FeedbackType)(0), // 3: AlarmFeedback.FeedbackType
	(IpInterface_PrimaryType)(0),    // 4: IpInterface.PrimaryType
	(TopologyRef_Protocol)(0),       // 5: TopologyRef.Protocol
	(*NodeCriteria)(nil),            // 6: NodeCriteria
	(*EventParameter)(nil),          // 7: EventParameter
	(*SnmpInfo)(nil),                // 8: SnmpInfo
	(*Event)(nil),                   // 9: Event
	(*Alarm)(nil),                   // 10: Alarm
	(*AlarmFeedback)(nil),           // 11: AlarmFeedback
	(*IpInterface)(nil),             // 12: IpInterface
	(*SnmpInterface)(nil),           // 13: SnmpInterface
	(*HwAlias)(nil),                 // 14: HwAlias
	(*HwEntity)(nil),                // 15: HwEntity
	(*Node)(nil),                    // 16: Node
	(*TopologyRef)(nil),             // 17: TopologyRef
	(*TopologySegment)(nil),         // 18: TopologySegment
	(*TopologyPort)(nil),            // 19: TopologyPort
	(*TopologyEdge)(nil),            // 20: TopologyEdge
}
var file_opennms_kafka_producer_proto_depIdxs = []int32{
	7,  // 0: Event.parameter:type_name -> EventParameter
	0,  // 1: Event.severity:type_name -> Severity
	6,  // 2: Event.node_criteria:type_name -> NodeCriteria
	8,  // 3: Event.snmpInfo:type_name -> SnmpInfo
	6,  // 4: Alarm.node_criteria:type_name -> NodeCriteria
	2,  // 5: Alarm.type:type_name -> Alarm.Type
	0,  // 6: Alarm.severity:type_name -> Severity
	9,  // 7: Alarm.last_event:type_name -> Event
	10, // 8: Alarm.relatedAlarm:type_name -> Alarm
	1,  // 9: Alarm.trouble_ticket_state:type_name -> TroubleTicketState
	3,  // 10: AlarmFeedback.feedback_type:type_name -> AlarmFeedback.FeedbackType
	4,  // 11: IpInterface.primary_type:type_name -> IpInterface.PrimaryType
	14, // 12: HwEntity.ent_hw_alias:type_name -> HwAlias
	15, // 13: HwEntity.children:type_name -> HwEntity
	12, // 14: Node.ip_interface:type_name -> IpInterface
	13, // 15: Node.snmp_interface:type_name -> SnmpInterface
	15, // 16: Node.hw_inventory:type_name -> HwEntity
	5,  // 17: TopologyRef.protocol:type_name -> TopologyRef.Protocol
	17, // 18: TopologySegment.ref:type_name -> TopologyRef
	6,  // 19: TopologyPort.node_criteria:type_name -> NodeCriteria
	17, // 20: TopologyEdge.ref:type_name -> TopologyRef
	19, // 21: TopologyEdge.sourcePort:type_name -> TopologyPort
	18, // 22: TopologyEdge.sourceSegment:type_name -> TopologySegment
	16, // 23: TopologyEdge.sourceNode:type_name -> Node
	19, // 24: TopologyEdge.targetPort:type_name -> TopologyPort
	18, // 25: TopologyEdge.targetSegment:type_name -> TopologySegment
	16, // 26: TopologyEdge.targetNode:type_name -> Node
...
func file_opennms_kafka_producer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_opennms_kafka_producer_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
	...
	file_opennms_kafka_producer_proto_msgTypes[14].OneofWrappers = []interface{}{
